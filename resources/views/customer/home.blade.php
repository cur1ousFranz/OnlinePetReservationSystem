<x-navbar>
    <x-layout>
        <div class="container-fluid row mb-2">
            ...
            <div class="col-lg">
                <form action="" class="ms-auto float-lg-end">
        ...
        <div class="card border-end-0 border-start-0 border-bottom-0">
            <div class="card-body">
                ...
                @forelse (array_chunk($pet->toArray(), 3) as $set)
                    <div class="row d-flex justify-content-around">
                        @foreach ($set as $pet)
                            <div class="col-lg-3 card shadow rounded rounded-3 mt-4">
                                <img class="card-img-top w-100 mt-2 border" src="{{ asset('/storage/' . $pet['image']) }}"
                                alt="Image of {{ $pet['type'] }}" style="height: 200px">
